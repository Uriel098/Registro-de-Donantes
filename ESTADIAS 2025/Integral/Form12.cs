...
namespace Integral
{
    public partial class Form12 : Form
    {
        ...
        string archivo = Directory.GetCurrentDirectory() + "\\InformeDeEstudiantes.html";
       
        private void button1_Click(object sender, EventArgs e)
        {

            StreamWriter arch = new StreamWriter(archivo);
            arch.WriteLine("<html>INFORME GENERAL DE ESTUDIANTES<br><br>");
            arch.WriteLine("<table border=1 cellspacing=0>");
            arch.WriteLine("<tr><td>Id_Estudiante</td><td>Estudiante</td><td>Matricula</td><td>carr</td><td>Id_carrera</td></tr>");
